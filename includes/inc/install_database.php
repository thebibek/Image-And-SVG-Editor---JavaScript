<?php
	function create_table($table_name, $table_data, $data, $auto_increment){
		global $db;
		$table_exist = $db->excute_query('SELECT 1 FROM '. $table_name .' LIMIT 1');
		if(!$table_exist){
			$create_table = $db->excute_query($table_data);
			if($create_table){
				$insert_data = $db->excute_query($data);
			}
		}
		$db->excute_query("ALTER TABLE $table_name ADD PRIMARY KEY (`id`);");
		$db->excute_query("ALTER TABLE $table_name MODIFY `id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=" . $auto_increment);
	}

	// Admin Table
	create_table('admins', 'CREATE TABLE `admins` (
  `id` int(11) NOT NULL,
...
(1, 'admin', 'admin@gmail.com', '$2y$10$6Z2zWYvbAEjFTJPoZ2r1V.DmXRWdjt9zpOIPnZRHRFVVqmT2i1YR6', '71f69ea0ab20185e732f4167a449f2c2', '2020-07-27 11:48:29')", 2);

	// Categories Table
	create_table('categories', 'CREATE TABLE `categories` (
  `id` int(11) NOT NULL,
  `name` varchar(250) NOT NULL,
  `icon` varchar(250) NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4',"INSERT INTO `categories` (`id`, `name`, `icon`) VALUES
(7, 'Backgrounds', '<i class=\"fas fa-images\"></i>'),
(11, 'Clip Arts', '<i class=\"far fa-sun\"></i>'),
(14, 'Emojis', '<i class=\"far fa-grin-hearts\"></i>'),
(15, 'Icons', '<i class=\"fab fa-connectdevelop\"></i>')", 17);

	// Media Table
	create_table('media', 'CREATE TABLE `media` (
  `id` int(11) NOT NULL,
  `name` varchar(250) NOT NULL,
  `src` varchar(250) NOT NULL,
  `type` varchar(20) NOT NULL,
  `category_id` int(11) NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4', "INSERT INTO `media` (`id`, `name`, `src`, `type`, `category_id`) VALUES
...
(546, 'Whatsapp Yellow Emojis', '6eccb56b9acd4d38722ea1eded14fae14.png', '', 14)", 547);